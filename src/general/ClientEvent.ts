import {
	...
	WebhookData
} from "eris"; import CoreClient from "../CoreClient";
``

// @TODO FIND A WAY TO MAKE THIS NOT MANUAL
export default class ClientEvent<C extends CoreClient = CoreClient> {
	...
	constructor(event: "guildEmojisUpdate", listener: (this: C, guild: Guild, emojis: Emoji[], oldEmojis: Emoji[]) => void);
	constructor(event: "guildMemberAdd", listener: (this: C, guild: Guild, member: Member) => void);
	constructor(event: "guildMemberChunk", listener: (this: C, guild: Guild, members: Member[]) => void);
	constructor(event: "guildMemberRemove", listener: (this: C, guild: Guild, member: Member | MemberPartial) => void);
	constructor(event: "guildMemberUpdate", listener: (this: C, guild: Guild, member: Member, oldMember: { nick?: string; premiumSince: number; roles: string[] } | null) => void);
	...
	constructor(event: "messageDeleteBulk", listener: (this: C, messages: PossiblyUncachedMessage[]) => void);
	...
	constructor(event: string, listener: (this: C, ...args: any[]) => void) {
		this.event = event;
		this.listener = listener;
	}

	async handle(client: C, ...d: any[]) {
