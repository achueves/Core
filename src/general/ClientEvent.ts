...
export default class ClientEvent<C extends CoreClient> {
	...
	constructor(event: "connect" | "shardPreReady" | "shardReady" | "shardResume", listener: (this: C, id: number) => void);
	...
	constructor(event: "guildMemberUpdate", listener: (this: C, guild: Guild, member: Member, oldMember: { nick?: string; premiumSince: number; roles: Array<string>; } | null) => void);
